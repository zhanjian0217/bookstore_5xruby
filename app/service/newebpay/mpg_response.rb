...
module Newebpay
  class MpgResponse
    attr_reader :status, :message, :result, :order_no, :trans_no, :merchant_id, :amount, :payment_type, :respond_type,
                :paytime, :trade_ip, :escrow_bank, :auth_bank, :respond_code, :auth, :card6_no, :card4_no, :payment_method
